...
playlist = Playlist("https://www.youtube.com/playlist?list=PL4Qsk8HhL0PtunPc8jEADP36ndjdmlwQE")
...
for vid in playlist.videos:
    print(vid)
for url in playlist:
    YouTube(url).streams.filter(only_audio=True).first().download("./test")
# for url in playlist:
